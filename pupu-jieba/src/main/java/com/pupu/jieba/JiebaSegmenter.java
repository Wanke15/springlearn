package com.pupu.jieba;

import com.pupu.jieba.viterbi.FinalSeg;
...
public class JiebaSegmenter {
    ...
    public static void main(String[] args) {
        ...
        List<SegToken> tokens = segmenter.process("我爱你中国", JiebaSegmenter.SegMode.SEARCH);
        for(SegToken segToken: tokens) {
            System.err.println(segToken.word);
        }
